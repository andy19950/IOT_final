...
public class Switchs {
     ...
     */
    public static void switchDesk(String appId, boolean newState) {
        SampleMonitor.SCL.doRequest(new RequestIndication("EXECUTE",SampleMonitor.SCLID+"/applications/"+appId+"/"+Desk.APOCPATH+"/"+newState,SampleMonitor.REQENTITY, ""));
