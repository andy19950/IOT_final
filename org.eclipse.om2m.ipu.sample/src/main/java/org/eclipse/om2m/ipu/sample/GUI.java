            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                new Thread(){
                    public void run() {
                        ...
                        Switchs.switchDesk(LAMP_0, !SampleMonitor.DESKS.get(LAMP_0).getState());
                    }
                }.start();
            }
        });
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                new Thread(){
                    public void run() {
                        ...
                        Switchs.switchDesk(LAMP_1, !SampleMonitor.DESKS.get(LAMP_1).getState());
                    }
                }.start();
            }
        });
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                new Thread(){
                    public void run(){
                        ...
                        Switchs.switchAll(!(SampleMonitor.DESKS.get(LAMP_0).getState() && SampleMonitor.DESKS.get(LAMP_1).getState()));
                    }
                }.start();
            }
        });
